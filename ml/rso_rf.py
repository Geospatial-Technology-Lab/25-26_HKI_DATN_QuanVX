"""
Tối ưu hóa Randomized Search cho Random Forest - Đã đồng bộ với rso_optimizer
"""
...
def main():
    """Hàm chính để chạy quá trình tối ưu hóa Random Forest bằng Randomized Search."""
    try:
        # Chuẩn bị dữ liệu
        ...
        print("\nBắt đầu tối ưu hóa Random Forest bằng Randomized Search...")
        print("=" * 80)
        
        # Sử dụng RandomizedSearch từ rso_optimizer
        rf_optimizer = RandomizedSearch(
            X=X, 
            y=y, 
            model_name='rf', 
