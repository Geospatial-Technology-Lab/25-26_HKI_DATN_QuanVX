"""
Tối ưu hóa Randomized Search cho SVM - Đã đồng bộ với rso_optimizer
"""
...
def main():
    """Hàm chính để chạy quá trình tối ưu hóa SVM bằng Randomized Search."""
    try:
        # Chuẩn bị dữ liệu
        ...
        print("\nBắt đầu tối ưu hóa SVM bằng Randomized Search...")
        print("=" * 80)
        
        # Sử dụng RandomizedSearch từ rso_optimizer
        svm_optimizer = RandomizedSearch(
            X=X, 
            y=y, 
            model_name='svm', 
